      ...
      <div className='w-full bg-[#e5e5e5] p-24'>
        <div className='w-[423px] h-[291px] m-auto flex flex-col gap-6 items-center'>
          ...
          <form className='flex flex-col flex-1 w-full justify-between'>
            <input placeholder='Escreva seu email' className='h-16 p-3 rounded shadow outline-none' />
            <input placeholder='Escreva sua senha' className='h-16 p-3 rounded shadow outline-none' type='password' />
            <Button Text='Entrar' />
          </form>
